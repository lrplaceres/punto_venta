...
import app.schemas.dependiente
...
@router.post("/dependiente", response_model=app.schemas.dependiente.Dependiente, status_code=status.HTTP_201_CREATED, tags=["dependiente"])
async def create_user(dependiente: app.schemas.dependiente.DependienteCreate, token: Annotated[str, Depends(auth.oauth2_scheme)], current_user: Annotated[models.User, Depends(auth.get_current_user)]):
...
@router.get("/dependientes", response_model=List[app.schemas.dependiente.DependienteList], tags=["dependiente"], description="Listado de dependientes por puntos segun propietario")
...
@router.get("/dependiente/{id}", response_model=app.schemas.dependiente.Dependiente, tags=["dependiente"])
...
async def update_user(id: int, user: app.schemas.dependiente.DependienteEdit, token: Annotated[str, Depends(auth.oauth2_scheme)], current_user: Annotated[models.User, Depends(auth.get_current_user)]):
...
async def update_user(id: int, user: app.schemas.dependiente.DependienteCambiaPasswordPropietario, token: Annotated[str, Depends(auth.oauth2_scheme)], current_user: Annotated[models.User, Depends(auth.get_current_user)]):
